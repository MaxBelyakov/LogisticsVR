...
namespace Police
{
    ...
    public class PoliceAIControl : MonoBehaviour
    {
        ...
        private PoliceController m_CarController;    // Reference to actual car controller we are controlling
        ...
        private void Awake()
        {
            ...
            m_CarController = GetComponent<PoliceController>();
        ...
        private void OnCollisionStay(Collision col)
        {
            ...
            {
                var otherAI = col.rigidbody.GetComponent<PoliceAIControl>();
                if (otherAI != null)
                {
